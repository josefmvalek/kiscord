...
export function generateDailyQuestionCard() {
    ...
    if (!myAnswer) {
                    ...
                    <div class="bg-[#2f3136]/50 p-4 rounded-xl border border-dashed border-gray-700 min-h-[100px] flex flex-col items-center justify-center text-center backdrop-blur-sm">
                        ...
                        ` : `
                            <div class="flex flex-col items-center opacity-40">
                                <i class="fas fa-hourglass-half text-gray-400 text-xl mb-2"></i>
                                <p class="text-[10px] text-gray-400 font-bold leading-none mb-1">Zatím neodpovězeno</p>
                                <p class="text-[8px] text-gray-500 uppercase font-black">Čeká se na odpověď</p>
                            </div>
                        `}
                    </div>
                </div>
        ...
        content += `
            <div class="grid grid-cols-2 gap-4 relative z-10 animate-fade-in">
                <div class="space-y-2">
                    <span class="text-[9px] uppercase font-black tracking-tighter text-gray-500 ml-1">Moje odpověď</span>
                    <div class="bg-black/20 p-4 rounded-xl border border-white/5 min-h-[100px]">
                        <p class="text-xs text-gray-200 leading-relaxed font-medium">${myAnswer.answer_text}</p>
                    </div>
                </div>
                <div class="space-y-2">
                    <span class="text-[9px] uppercase font-black tracking-tighter text-gray-500 ml-1">${state.currentUser.name === 'Jožka' ? 'Klárka' : 'Jožka'}</span>
                    <div class="bg-[#eb459e]/10 p-4 rounded-xl border border-[#eb459e]/30 min-h-[100px]">
                        <p class="text-xs text-pink-200 leading-relaxed font-medium">${partnerAnswer.answer_text}</p>
                    </div>
                </div>
            </div>
        `;
