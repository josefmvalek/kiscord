    ...
    badge.innerHTML = `
        <div class="flex justify-between items-center mb-1">
            ...
            <span class="text-[9px] text-[#faa61a] font-bold flex items-center gap-1.5">
                ...
                <span class="text-yellow-400 font-black flex items-center gap-0.5" id="sidebar-coins-display">
        ...
        <div class="flex justify-between items-center mt-1">
            <span class="text-[9px] text-gray-400 font-medium truncate italic max-w-[130px]">${info.title}</span>
            <span class="text-[8px] text-gray-500 font-semibold">${info.progressPercentage}%</span>
        </div>
    `;
