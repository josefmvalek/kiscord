                ...
                <div class="grid grid-cols-2 gap-6 md:gap-12 mt-12 px-4">
                    ...
                    <button onclick="window.submitGameVote('${question.id}', '${josefId}')" 
                        ...
                        <div class="relative mb-4">
                            <img src="${getAssetUrl('jozka_profile')}" loading="lazy" class="w-24 h-24 md:w-32 md:h-32 rounded-3xl object-cover shadow-lg border-4 ${myVote?.voted_for_user_id === josefId ? 'border-[#faa61a] ring-4 ring-[#faa61a]/30' : 'border-[#202225] group-hover:border-[#faa61a]/50'} transition-all ${myVote && myVote.voted_for_user_id !== josefId ? 'grayscale' : ''}">
                    ...
                    <button onclick="window.submitGameVote('${question.id}', '${klarkaId}')" 
                        ...
                        ${myVote ? 'disabled' : ''}>
                        <div class="relative mb-4">
                            <img src="${getAssetUrl('klarka_profile')}" loading="lazy" class="w-24 h-24 md:w-32 md:h-32 rounded-3xl object-cover shadow-lg border-4 ${myVote?.voted_for_user_id === klarkaId ? 'border-[#faa61a] ring-4 ring-[#faa61a]/30' : 'border-[#202225] group-hover:border-[#faa61a]/50'} transition-all ${myVote && myVote.voted_for_user_id !== klarkaId ? 'grayscale' : ''}">
