...
export async function handleNextDateClick(dateKey) {
    ...
    const { showDayDetail } = await import('@domains/lifestyle/calendar/index.js');
...
export async function submitQuickPlanWithDate() {
    ...
    try {
        ...
        if (quickPlanData.couponId) {
            const loveShop = await import('@domains/couple/love-shop/index.js');
        ...
        const { renderDashboard } = await import('@domains/lifestyle/dashboard/index.js');
        renderDashboard();
