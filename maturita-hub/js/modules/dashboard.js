...
export async function renderDashboard(container) {
    ...
    container.innerHTML = `
        <div id="matura-hub-dashboard" class="pt-8 space-y-20 animate-fade-in relative">
            
            <div class="flex flex-col md:flex-row gap-6 mb-12">
                 <!-- Hello Card -->
                 <div class="flex-1 card bg-gradient-to-br from-blurple to-[#34373c] p-12 flex flex-col justify-center">
                 ...
                 <!-- Quick Stats Row -->
                 <div class="grid grid-cols-2 md:grid-cols-2 gap-8 flex-shrink-0 w-full md:w-96">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-16">
                ...
                <div class="lg:col-span-1 space-y-10">
                    ...
                    <div id="study-room-list" class="space-y-4">
                ...
                <div class="lg:col-span-2 space-y-10">
                    ...
                    <div id="priority-topics-grid" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ${renderPriorityTopics()}
                    </div>
                    
                    <!-- Pomodoro Focus Card -->
                    <div class="card bg-darkSecondary h-56 flex items-center justify-between p-12 overflow-hidden group">
