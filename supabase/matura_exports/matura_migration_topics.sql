...
('it2', 'it', '02 - Kódování a komprese', NULL, '📦', 'Teorie', 'Binární kódování, ASCII, Unicode, komprese.', true, '[{"q": "Kolik bitů má standardní ASCII?", "a": "7 bitů (128 znaků)."}, {"q": "Rozdíl mezi ztrátovou a bezeztrátovou kompresí?", "a": "U ztrátové dochází k nevratnému zahubení části dat pro menší velikost (např. MP3, JPEG)."}]'::jsonb),
