...
1. **Crawling (Procházení):** Softwaroví roboti (**crawleři**) neustále procházejí web, načítají stránky a ukládají je do databáze. Zpravodajské weby navštěvují častěji kvůli aktuálnosti.
...
<ul class="matura-trust-flow">
  <li>Recenzované vědecké články (nejvyšší úroveň důvěryhodnosti)</li>
  <li>Odborné články a knihy</li>
  <li>Úřední zprávy, data a dokumenty</li>
  <li>Seriózní noviny, časopisy, veřejnoprávní média</li>
  <li>Bulvární noviny, časopisy a média</li>
  <li>Sociální sítě, blogy, chatovací aplikace, sdílené informace</li>
  <li>Dezinformační média (nejnižší úroveň důvěryhodnosti)</li>
</ul>
